	...
	class WPCleverWoosg {
                ...
                <div class="wpclever_settings_page_content">
					<?php if ( $active_tab === 'how' ) { ?>
                        <div class="wpclever_settings_page_content_text">
                            ...
                            <p>
                                <img src="<?php echo esc_url( WOOSG_URI . 'assets/images/how-01.jpg' ); ?>" alt=""/>
                            </p>
                        </div>
					<?php } elseif ( $active_tab === 'settings' ) {
						...
						$exclude_unpurchasable = WPCleverWoosg_Helper()::get_setting( 'exclude_unpurchasable', 'no' );
						...
						$show_atc              = WPCleverWoosg_Helper()::get_setting( 'show_atc', 'whole' );
                        ...
                        <form method="post" action="options.php">
                            <table class="form-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[price_format]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[archive_purchasable]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[position]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[layout]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[variations_selector]">
                                ...
                                <tr>
                                    <th><?php esc_html_e( 'Exclude unpurchasable', 'wpc-grouped-product' ); ?></th>
                                    <td>
                                        <label> <select name="woosg_settings[exclude_unpurchasable]">
                                                <option value="yes" <?php selected( $exclude_unpurchasable, 'yes' ); ?>><?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?></option>
                                                <option value="no" <?php selected( $exclude_unpurchasable, 'no' ); ?>><?php esc_html_e( 'No', 'wpc-grouped-product' ); ?></option>
                                            </select> </label>
                                        <span class="description"><?php esc_html_e( 'Exclude unpurchasable products from the list.', 'wpc-grouped-product' ); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Show thumbnail', 'wpc-grouped-product' ); ?></th>
                                    <td>
                                        <label> <select name="woosg_settings[show_thumb]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[show_description]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[show_price]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[selector]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[show_plus_minus]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[show_atc]">
                                                <option value="each" <?php selected( $show_atc, 'each' ); ?>><?php esc_html_e( 'Yes, for each sub-product', 'wpc-grouped-product' ); ?></option>
                                                <option value="whole" <?php selected( $show_atc, 'whole' ); ?>><?php esc_html_e( 'Yes, for the whole group', 'wpc-grouped-product' ); ?></option>
                                                <option value="both" <?php selected( $show_atc, 'both' ); ?>><?php esc_html_e( 'Yes, for both the whole group and each sub-product', 'wpc-grouped-product' ); ?></option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[link]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[change_image]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[change_price]" class="woosg_change_price">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[including_main]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> <select name="woosg_settings[main_price]">
		...
		function search_settings() {
            ...
            <tr>
                ...
                <td>
                    <label> <select name="woosg_settings[search_sku]" class="woosg_search_sku">
            ...
            <tr>
                ...
                <td>
                    <label> <select name="woosg_settings[search_id]" class="woosg_search_id">
            ...
            <tr>
                ...
                <td>
                    <label> <select name="woosg_settings[search_exact]" class="woosg_search_exact">
            ...
            <tr>
                ...
                <td>
                    <label> <select name="woosg_settings[search_sentence]" class="woosg_search_sentence">
            ...
            <tr>
                ...
                <td>
                    <label> <select name="woosg_settings[search_same]" class="woosg_search_same">
		...
		function ajax_get_search_results() {
			...
			if ( ( WPCleverWoosg_Helper()::get_setting( 'search_id', 'no' ) === 'yes' ) && is_numeric( $keyword ) ) {
				...
				$limit = WPCleverWoosg_Helper()::get_setting( 'search_limit', 10 );
			...
			if ( $query->have_posts() ) {
				...
				echo '<ul><span>' . sprintf( /* translators: keyword */ esc_html__( 'No results found for "%s"', 'wpc-grouped-product' ), esc_html( $keyword ) ) . '</span></ul>';
			}
            ...
            <div id='woosg_settings' class='panel woocommerce_options_panel woosg_table'>
                ...
                <table>
                    ...
                    <tr class="woosg_tr_space">
                        ...
                        <td>
                            <label> <select name="woosg_show_atc">
                    ...
                    <tr class="woosg_tr_space">
                        <th><?php esc_html_e( 'Include main product', 'wpc-grouped-product' ); ?></th>
                        <td>
                            <label> <select name="woosg_including_main">
                    ...
                    <tr class="woosg_tr_space">
                        <th><?php esc_html_e( 'Product selector', 'wpc-grouped-product' ); ?></th>
                        <td>
                            <label> <select name="woosg_selector">
                    ...
                    <tr class="woosg_tr_space">
                        ...
                        <td>
                            ...
                            <label> <select name="woosg_layout">
		...
		function show_items( $product = null ) {
			...
			$wrap_class       = apply_filters( 'woosg_wrap_class', 'woosg-wrap woosg-wrap-layout-' . $layout . ' woosg-wrap-show-atc-' . $show_atc, $product );
			$products_class   = apply_filters( 'woosg_products_class', 'woosg-products woosg-products-layout-' . $layout . ' woosg-show-atc-' . $show_atc, $product );

			if ( $items = $product->get_items() ) {
				do_action( 'woosg_above_wrap', $product );

				echo '<div class="' . esc_attr( $wrap_class ) . '" data-id="' . esc_attr( $product_id ) . '">';
				...
				if ( $before_text = apply_filters( 'woosg_before_text', get_post_meta( $product_id, 'woosg_before_text', true ) ?: WPCleverWoosg_Helper()::localization( 'above_text' ), $product_id ) ) {
					echo '<div class="woosg_before_text woosg-before-text woosg-text">' . wp_kses_post( do_shortcode( $before_text ) ) . '</div>';
				}
                ...
                <div class="<?php echo esc_attr( $products_class ); ?>" data-variables="<?php echo esc_attr( $product->has_variables() ? 'yes' : 'no' ); ?>" data-price="<?php echo esc_attr( $main_price ); ?>" data-regular-price="<?php echo esc_attr( $main_regular_price ); ?>" data-price-suffix="<?php echo esc_attr( htmlentities( $product->get_price_suffix() ) ); ?>">
					...
					foreach ( $items as $item ) {
						if ( ! empty( $item['id'] ) ) {
							...
							if ( ( WPCleverWoosg_Helper()::get_setting( 'exclude_unpurchasable', 'no' ) === 'yes' ) && ( ! $product->is_purchasable() || ! $product->is_in_stock() ) ) {
								continue;
							}
                            ...
                            <div class="<?php echo esc_attr( apply_filters( 'woosg_item_class', $item_class, $product, $global_product ) ); ?>" data-name="<?php echo esc_attr( $product_name ); ?>" data-id="<?php echo esc_attr( $item_id ); ?>" data-price="<?php echo esc_attr( $item_price ); ?>" data-regular-price="<?php echo esc_attr( $item_regular_price ); ?>" data-qty="<?php echo esc_attr( $item_qty ); ?>" data-order="<?php echo esc_attr( $order ); ?>" data-wpcpq="<?php echo esc_attr( json_encode( $item_wpcpq ) ); ?>">
								...
								if ( ( $selector === 'checkbox' ) && ( $show_atc === 'all' || $show_atc === 'whole' ) ) {
									?>
								...
								<?php
								if ( ( $selector === 'quantity' ) && ( $show_atc === 'all' || $show_atc === 'whole' ) ) {
									if ( $product->is_purchasable() && $product->is_in_stock() ) {
								...
								if ( $show_atc === 'each' || $show_atc === 'both' ) {
									?>
                                    <div class="woosg-atc">
				...
				if ( $after_text = apply_filters( 'woosg_after_text', get_post_meta( $product_id, 'woosg_after_text', true ) ?: WPCleverWoosg_Helper()::localization( 'under_text' ), $product_id ) ) {
					echo '<div class="woosg_after_text woosg-after-text woosg-text">' . wp_kses_post( do_shortcode( $after_text ) ) . '</div>';
				}
		...
		function display_post_states( $states, $post ) {
			if ( ( 'product' == get_post_type( $post->ID ) ) && ( $product = wc_get_product( $post->ID ) ) && $product->is_type( 'woosg' ) ) {
				...
				$states[] = apply_filters( 'woosg_post_states', '<span class="woosg-state">' . sprintf( /* translators: count */ esc_html__( 'Grouped (%d)', 'wpc-grouped-product' ), $count ) . '</span>', $count, $product );
			}
				...
				if ( is_array( $ids ) ) {
					...
					if ( is_array( $items ) && count( $items ) > 0 ) {
						foreach ( $items as $item ) {
							...
							$data[]    = [
								'id'    => apply_filters( 'woosg_item_id', absint( $item_data[0] ?? 0 ) ),
								'qty'   => apply_filters( 'woosg_item_qty', (float) ( $item_data[1] ?? 0 ) ),
		...
		function export_process( $value, $meta, $product ) {
			if ( $meta->key === 'woosg_ids' ) {
				$ids = get_post_meta( $product->get_id(), 'woosg_ids', true );
		...
		function import_process( $object, $data ) {
			if ( isset( $data['meta_data'] ) ) {
				foreach ( $data['meta_data'] as $meta ) {
					if ( $meta['key'] === 'woosg_ids' ) {
						$object->update_meta_data( 'woosg_ids', json_decode( $meta['value'], true ) );
						break;
					}
				}
			}
