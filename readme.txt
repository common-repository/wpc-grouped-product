...
<ul>
<li>Easy to search & add product</li>
...
<li>Premium: Add a variable product or a specific variation to the grouped product</li>
...
= 5.1.1 =
* Fixed: Add price suffix

= 5.1.0 =
* Updated: Compatible with WP 6.6 & Woo 9.1

= 5.0.9 =
* Fixed: Unclear description

= 5.0.8 =
* Added: Filter hook 'woosg_product_types'

= 5.0.7 =
* Added: Show add-to-cart button for both the whole group and each sub-product

= 5.0.6 =
* Updated: Compatible with WP 6.5 & Woo 8.9

= 5.0.5 =
* Added: Option to exclude unpurchasable products from the list

= 5.0.4 =
* Updated: Compatible with WP 6.5 & Woo 8.8

= 5.0.3 =
* Fixed: Missing 'woosg_ids' on exported file

= 5.0.2 =
* Fixed: Convert tool doesn't work
* Fixed: Short description of variation

= 5.0.1 =
* Updated: Optimized the code

= 5.0.0 - BIG UPDATE =
* Updated: The number of products allowed is now unlimited. However, adding variables/variations is only possible on the Premium version.
...
= 4.4.0 =
* Added: Show add-to-cart button on each sub-product or the whole group

= 4.3.1 =
* Added: Purchasable on archive

= 4.3.0 =
* Added: Convert tool to convert all native grouped products to smart grouped

= 4.2.8 =
* Fixed: Minor CSS/JS issues in the backend

= 4.2.7 =
* Updated: Implement role/permission and nonce check
